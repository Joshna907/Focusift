   ...
   return (
    <main className="min-h-screen bg-[#0A0A23] text-white overflow-x-hidden">
      <nav className="flex items-center justify-between py-4 px-6 border-b border-white/10">
        <div className="text-2xl font-bold tracking-tight">Focusift</div>

        <div className="space-x-4">
          {session ? (
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex items-center justify-center rounded-full bg-white/5 hover:bg-white/10 p-2 shadow-sm backdrop-blur">
              ...
              <DropdownMenuContent
                align="end"
                className="w-48 rounded-xl bg-white/10 backdrop-blur text-white shadow-xl border border-white/20"
              >
                <DropdownMenuItem
                  onClick={() => (window.location.href = "/dashboard")}
                  className="flex items-center gap-2 px-4 py-2 hover:bg-blue-500/20 rounded-md transition"
                >
                ...
                <DropdownMenuItem
                  onClick={() => signOut()}
                  className="flex items-center gap-2 px-4 py-2 text-red-400 hover:bg-red-500/20 rounded-md transition"
                >
